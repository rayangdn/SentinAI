...
def get_explain_results(args):
    ...
    # Create absolute paths for all your directories
    # Store the original directory
    original_dir = os.getcwd()
    save_path_abs = os.path.abspath(save_path)
    result_file_dir_abs = os.path.abspath(result_file_dir)
    score_file_dir_abs = os.path.abspath(score_file_dir)
    
    os.chdir('./eraserbenchmark')
    os.system('PYTHONPATH=./:$PYTHONPATH python rationale_benchmark/metrics.py --split test --strict --data_dir {} --results {} --score_file {}'.format(save_path_abs, result_file_dir_abs, score_file_dir_abs))
